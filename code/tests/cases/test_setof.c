...
FOSSIL_TEST_CASE(c_test_setof_insert) {
...
FOSSIL_TEST_CASE(c_test_setof_remove) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
...
FOSSIL_TEST_CASE(c_test_setof_contains) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    fossil_setof_insert(set, "42");
...
FOSSIL_TEST_CASE(c_test_setof_not_empty) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    fossil_setof_insert(set, "42");
...
FOSSIL_TEST_CASE(c_test_setof_is_empty) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    ASSUME_ITS_TRUE(fossil_setof_is_empty(set) == true);
    fossil_setof_insert(set, "42");
...
FOSSIL_TEST_CASE(c_test_setof_size) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
...
FOSSIL_TEST_CASE(c_test_setof_insert_multiple) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
...
FOSSIL_TEST_CASE(c_test_setof_remove_multiple) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    fossil_setof_insert(set, "1");
    fossil_setof_insert(set, "2");
...
FOSSIL_TEST_CASE(c_test_setof_create_copy) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    fossil_setof_insert(set, "42");
...
FOSSIL_TEST_CASE(c_test_setof_create_move) {
    fossil_setof_t* set = fossil_setof_create_container("i32");
    fossil_setof_insert(set, "42");
...
FOSSIL_TEST_GROUP(c_setof_tofu_tests) {    
    ...
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_insert);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_remove);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_contains);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_not_empty);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_is_empty);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_size);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_insert_multiple);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_remove_multiple);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_create_copy);
    FOSSIL_TEST_ADD(c_setof_tofu_fixture, c_test_setof_create_move);
