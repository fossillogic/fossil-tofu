...
FOSSIL_TEST(c_test_arraylist_create_and_destroy) {
    fossil_arraylist_t* alist = fossil_arraylist_create_container("i32", 8);
    ASSUME_NOT_CNULL(alist);
    ASSUME_ITS_EQUAL_CSTR(alist->type, "i32");
    ASSUME_ITS_TRUE(fossil_arraylist_is_empty(alist));
    fossil_arraylist_destroy(alist);
}

FOSSIL_TEST(c_test_arraylist_create_default) {
    fossil_arraylist_t* alist = fossil_arraylist_create_default();
    ASSUME_NOT_CNULL(alist);
...
FOSSIL_TEST(c_test_arraylist_insert_and_size) {
    fossil_arraylist_t* alist = fossil_arraylist_create_container("i32", 4);
...
FOSSIL_TEST(c_test_arraylist_get_and_set) {
    fossil_arraylist_t* alist = fossil_arraylist_create_container("i32", 4);
    fossil_arraylist_insert(alist, "100");
    fossil_arraylist_insert(alist, "200");
    fossil_arraylist_insert(alist, "300");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get(alist, 1), "200");
    fossil_arraylist_set(alist, 1, "250");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get(alist, 1), "250");
    fossil_arraylist_destroy(alist);
}

FOSSIL_TEST(c_test_arraylist_get_front_and_back) {
    fossil_arraylist_t* alist = fossil_arraylist_create_container("i32", 4);
    fossil_arraylist_insert(alist, "first");
    fossil_arraylist_insert(alist, "middle");
    fossil_arraylist_insert(alist, "last");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get_front(alist), "first");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get_back(alist), "last");
    fossil_arraylist_destroy(alist);
}

FOSSIL_TEST(c_test_arraylist_set_front_and_back) {
    fossil_arraylist_t* alist = fossil_arraylist_create_container("i32", 4);
    fossil_arraylist_insert(alist, "one");
    fossil_arraylist_insert(alist, "two");
    fossil_arraylist_insert(alist, "three");
    fossil_arraylist_set_front(alist, "ONE");
    fossil_arraylist_set_back(alist, "THREE");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get_front(alist), "ONE");
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get_back(alist), "THREE");
    fossil_arraylist_destroy(alist);
}

FOSSIL_TEST(c_test_arraylist_copy_and_move) {
    fossil_arraylist_t* alist1 = fossil_arraylist_create_container("i32", 4);
    fossil_arraylist_insert(alist1, "5");
    fossil_arraylist_insert(alist1, "10");
    fossil_arraylist_insert(alist1, "15");
    fossil_arraylist_t* alist2 = fossil_arraylist_create_copy(alist1);
    ASSUME_ITS_EQUAL_SIZE(fossil_arraylist_size(alist1), fossil_arraylist_size(alist2));
    ASSUME_ITS_EQUAL_CSTR(fossil_arraylist_get(alist2, 1), "10");
    fossil_arraylist_t* alist3 = fossil_arraylist_create_move(alist1);
    ASSUME_ITS_TRUE(fossil_arraylist_is_empty(alist1));
    ASSUME_ITS_EQUAL_SIZE(fossil_arraylist_size(alist3), 3);
    fossil_arraylist_destroy(alist2);
    fossil_arraylist_destroy(alist3);
    fossil_arraylist_destroy(alist1);
}

FOSSIL_TEST(c_test_arraylist_empty_and_null_checks) {
    fossil_arraylist_t* alist = NULL;
    ASSUME_ITS_TRUE(fossil_arraylist_is_cnullptr(alist));
    alist = fossil_arraylist_create_container("i32", 4);
    ASSUME_ITS_TRUE(fossil_arraylist_not_cnullptr(alist));
    ASSUME_ITS_TRUE(fossil_arraylist_is_empty(alist));
    fossil_arraylist_insert(alist, "42");
    ASSUME_ITS_TRUE(fossil_arraylist_not_empty(alist));
    fossil_arraylist_destroy(alist);
}
