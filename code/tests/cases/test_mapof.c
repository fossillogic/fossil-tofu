...
FOSSIL_TEST_CASE(c_test_mapof_insert) {
...
FOSSIL_TEST_CASE(c_test_mapof_remove) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
...
FOSSIL_TEST_CASE(c_test_mapof_contains) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_get) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_set) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_size) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_not_empty) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_is_empty) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    ASSUME_ITS_TRUE(fossil_mapof_is_empty(map) == true);
    fossil_mapof_insert(map, "key1", "value1");
...
FOSSIL_TEST_CASE(c_test_mapof_insert_multiple) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    ASSUME_ITS_TRUE(fossil_mapof_insert(map, "key1", "value1") == FOSSIL_TOFU_SUCCESS);
...
FOSSIL_TEST_CASE(c_test_mapof_remove_multiple) {
    fossil_mapof_t* map = fossil_mapof_create_container("cstr", "cstr");
    fossil_mapof_insert(map, "key1", "value1");
    fossil_mapof_insert(map, "key2", "value2");
...
FOSSIL_TEST_GROUP(c_mapof_tofu_tests) {    
    ...
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_insert);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_remove);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_contains);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_get);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_set);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_size);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_not_empty);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_is_empty);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_insert_multiple);
    FOSSIL_TEST_ADD(c_mapof_tofu_fixture, c_test_mapof_remove_multiple);
