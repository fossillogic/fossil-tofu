...
FOSSIL_TEST(cpp_test_clist_insert) {
...
FOSSIL_TEST(cpp_test_clist_not_empty) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
    fossil_clist_insert(clist, const_cast<char*>("42"));
...
FOSSIL_TEST(cpp_test_clist_not_cnullptr) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
    ASSUME_ITS_TRUE(fossil_clist_not_cnullptr(clist) == true);
    fossil_clist_destroy(clist);
}

FOSSIL_TEST(cpp_test_clist_is_empty) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
    ASSUME_ITS_TRUE(fossil_clist_is_empty(clist) == true);
    fossil_clist_insert(clist, const_cast<char*>("42"));
...
FOSSIL_TEST(cpp_test_clist_is_cnullptr) {
...
FOSSIL_TEST(cpp_test_clist_size) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
    fossil_clist_insert(clist, const_cast<char*>("1"));
    fossil_clist_insert(clist, const_cast<char*>("2"));
...
FOSSIL_TEST(cpp_test_clist_insert_multiple) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
...
FOSSIL_TEST(cpp_test_clist_remove_multiple) {
    fossil_clist_t* clist = fossil_clist_create_container(const_cast<char*>("i32"));
    fossil_clist_insert(clist, const_cast<char*>("1"));
    fossil_clist_insert(clist, const_cast<char*>("2"));
    fossil_clist_insert(clist, const_cast<char*>("3"));
...
FOSSIL_TEST(cpp_test_clist_class_not_empty) {
    fossil::tofu::CList clist("i32");
    clist.insert("42");
    ASSUME_ITS_TRUE(clist.not_empty() == true);
}

FOSSIL_TEST(cpp_test_clist_class_not_cnullptr) {
    fossil::tofu::CList clist("i32");
    ASSUME_ITS_TRUE(clist.not_cnullptr() == true);
}

FOSSIL_TEST(cpp_test_clist_class_is_empty) {
    fossil::tofu::CList clist("i32");
    ASSUME_ITS_TRUE(clist.is_empty() == true);
    clist.insert("42");
...
FOSSIL_TEST(cpp_test_clist_class_is_cnullptr) {
    fossil::tofu::CList clist;
    ASSUME_ITS_TRUE(clist.is_cnullptr() == false);
}

FOSSIL_TEST(cpp_test_clist_class_reverse) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.insert("3");
...
FOSSIL_TEST(cpp_test_clist_class_size) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
...
FOSSIL_TEST(cpp_test_clist_class_insert_multiple) {
    fossil::tofu::CList clist("i32");
...
FOSSIL_TEST(cpp_test_clist_class_remove_multiple) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.insert("3");
...
FOSSIL_TEST(cpp_test_clist_class_get) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.insert("3");
...
FOSSIL_TEST(cpp_test_clist_class_get_front) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
...
FOSSIL_TEST(cpp_test_clist_class_get_back) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
...
FOSSIL_TEST(cpp_test_clist_class_set) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.set(1, "42");
...
FOSSIL_TEST(cpp_test_clist_class_set_front) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.set_front("42");
...
FOSSIL_TEST(cpp_test_clist_class_set_back) {
    fossil::tofu::CList clist("i32");
    clist.insert("1");
    clist.insert("2");
    clist.set_back("42");
