...
FOSSIL_TEST_CASE(c_test_dlist_insert_multiple) {
    ...
    ASSUME_ITS_TRUE(fossil_dlist_insert(dlist, "3") == FOSSIL_TOFU_SUCCESS);
...
FOSSIL_TEST_GROUP(c_dlist_tofu_tests) {    
    ...
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_insert);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_remove);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_not_empty);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_not_cnullptr);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_is_empty);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_is_cnullptr);
    ...
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_size);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_insert_multiple);
    FOSSIL_TEST_ADD(c_dlist_tofu_fixture, c_test_dlist_remove_multiple);
