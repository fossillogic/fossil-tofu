 ...
 * @note Time complexity: O(1)
 */
inline fossil_tuple_t *tuple_create(std::string type) {
 ...
 * @note Time complexity: O(1)
 */
inline fossil_tuple_t* tuple_create_default(void) {
    return fossil_tuple_create_default();
}
 ...
 * @note Time complexity: O(n)
 */
inline fossil_tuple_t* tuple_create_copy(const fossil_tuple_t* other) {
    return fossil_tuple_create_copy(other);
}
 ...
 * @note Time complexity: O(1)
 */
inline fossil_tuple_t* tuple_create_move(fossil_tuple_t* other) {
    return fossil_tuple_create_move(other);
}
 ...
 * @note Time complexity: O(n)
 */
inline void tuple_destroy(fossil_tuple_t *tuple) {
 ...
 * @note Time complexity: O(1) on average, O(n) in the worst case due to resizing.
 */
inline void tuple_add(fossil_tuple_t *tuple, std::string element) {
 ...
 * @note Time complexity: O(n)
 */
inline void tuple_remove(fossil_tuple_t *tuple, size_t index) {
 ...
 * @note Time complexity: O(1)
 */
inline size_t tuple_size(fossil_tuple_t *tuple) {
 ...
 * @note Time complexity: O(1)
 */
inline size_t tuple_capacity(fossil_tuple_t *tuple) {
 ...
 * @note Time complexity: O(1)
 */
inline bool tuple_is_empty(fossil_tuple_t *tuple) {
 ...
 * @note Time complexity: O(n)
 */
inline void tuple_clear(fossil_tuple_t *tuple) {
 ...
 * @note Time complexity: O(1)
 */
inline std::string tuple_get(fossil_tuple_t* tuple, size_t index) {
 ...
 * @note Time complexity: O(1)
 */
inline std::string tuple_get_front(const fossil_tuple_t* tuple) {
    return std::string(fossil_tuple_get_front(tuple));
}
 ...
 * @note Time complexity: O(1)
 */
inline std::string tuple_get_back(const fossil_tuple_t* tuple) {
    return std::string(fossil_tuple_get_back(tuple));
}
 ...
 * @note Time complexity: O(1)
 */
inline void tuple_set(fossil_tuple_t* tuple, size_t index, std::string element) {
    fossil_tuple_set(tuple, index, const_cast<char*>(element.c_str()));
}
 ...
 * @note Time complexity: O(1)
 */
inline void tuple_set_front(fossil_tuple_t* tuple, std::string element) {
    fossil_tuple_set_front(tuple, const_cast<char*>(element.c_str()));
}
 ...
 * @note Time complexity: O(1)
 */
inline void tuple_set_back(fossil_tuple_t* tuple, std::string element) {
    fossil_tuple_set_back(tuple, const_cast<char*>(element.c_str()));
}
